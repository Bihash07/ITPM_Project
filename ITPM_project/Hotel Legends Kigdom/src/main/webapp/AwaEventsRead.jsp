...
<body>
  <jsp:include page="main/header.jsp"/>
   ...
   <div class="container"  style=" width: 20px; margin: 30px 40px 10px 20px; ">
    <div class="title">Award Ceremonies Event Details</div>
    <div class="search">
      ...
      <form action="#" method="post">
        <table id="tbl-student" class="table">
				    		...
				    		con = DriverManager.getConnection("jdbc:mysql://localhost:3306/hotellegendskingdom","root","Root123.");			    		
				 			String query ="select * from Awa_event";
				 			...
				 			<tr id="myUL"  ">
				 				...
				 				<td><a href="AwaEventsUpdate.jsp?ceid=<%=id%>"><input class="btn edit" type="Button"  name="edit" value="EDIT"></a></td>
				 				<td><a href="AwaEventsDelete.jsp?ceid=<%=id%>"><input class="btn delete"  type="Button"  name="delete" value="DELETE"></a></td>
				 		  </tr>
