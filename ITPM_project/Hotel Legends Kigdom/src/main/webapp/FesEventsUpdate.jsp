...
<%@ page import="java.sql.*" %>
       ...
       <%
    	...
    	if(request.getParameter("submit")!=null)
    	{
    		...
    		pst = con.prepareStatement("update Fes_event set f_name =?,nic =?,email =?,phone =?,event_type =?,date =?,guestno =?,payment =? where ceid =?");
      ...
      <form action="#" method="post">
        <div class="user-details">
				...
				<%
			    		...
			    		String feid=request.getParameter("feid"); 
						pst = con.prepareStatement("select * from Fes_event where feid= ?");
			...
			<div class="input-box">
                ...
                <input type="text"  placeholder="Event Id" value="<%= rs.getString("feid")%>|<%= rs.getString("f_name")%>" name="ceid" id="ceid" readonly required> 
             </div><br><br>
             <div class="input-box">
             ...
             <div class="input-box">
                ...
                <select class="form-select" name="type" id="type">
                      ...
                      <option>ConferencesBeer festival</option>
             		  <option>Folk festival </option>
             		  <option>Food festival</option>
             		  <option>Music festival </option>
             		  <option>TFire festival</option>
             		  <option>Comedy festival</option>
               </select>    
             </div>  
             <div class="input-box">
			 ...
			 <div align="center">
				 <a href="FesEventsRead.jsp"><input class="btn view" type="Button" value="View Details"></a>
		     </div>
            </div>
          </form>
       </div>
