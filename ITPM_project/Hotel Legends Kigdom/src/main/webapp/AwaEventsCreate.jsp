...
<%@page import="java.sql.*" %>
    ...
    <%
    	...
    	if(request.getParameter("submit")!=null)
    	{
    		...
    		pst = con.prepareStatement("insert into Awa_event(f_name,nic,email,phone,event_type,date,guestno,payment)values(?,?,?,?,?,?,?,?)");
...
<body>
  ...
  <section class="home-section">
    ...
    <div class="container">
     <div class="title">Award Event Registration</div><br>
      <div class="content">
       <form action="#" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
             <span class="details">Award event Type</span>
          ...
          <div class="input-box">
             ...
             <select class="form-select" name="payment" placeholder="No of gest" id="payment" required>
                   ...
                   <option>1st class | Rs.250,000.00</option>
             	   <option>2nd class | Rs.135,000.00</option>
           ...
           <div>
               ...
               <a href="AwaEventsRead.jsp"><input class="btn view" type="Button" value="View Details" style="margin: 0 0 0 100px;"></a>
           </div>
          </form>
         </div>
       </div>
