...
<%@page import="java.sql.*" %>
    ...
    <%
    	...
    	if(request.getParameter("submit")!=null)
    	{
    		...
    		pst = con.prepareStatement("insert into Fes_event(f_name,nic,email,phone,event_type,date,guestno,payment)values(?,?,?,?,?,?,?,?)");
...
<body>
  ...
  <section class="home-section">
    ...
    <div class="container">
     <div class="title">Festivel Registration</div><br>
      <div class="content">
       <form action="#" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
             <span class="details">Festivel Type</span>
             <select class="form-select" name="type" id="type">
                  <option>Select Festivel Type</option>
          ...
          <div class="input-box">
           ...
           <div>
               ...
               <a href="FesEventsRead.jsp"><input class="btn view" type="Button" value="View Details" style="margin: 0 0 0 100px;"></a>
           </div>
          </form>
         </div>
       </div>
