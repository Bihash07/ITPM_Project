...
<%@ page import="java.sql.*" %>
       ...
       <%
    	...
    	{
    		String ceid= request.getParameter("peid");
    		...
    		pst = con.prepareStatement("update Per_event set f_name =?,nic =?,email =?,phone =?,event_type =?,date =?,guestno =?,payment =? where ceid =?");
    		...
    		location.href = 'PerEventsRead.jsp';
      ...
      <form action="#" method="post">
        <div class="user-details">
				...
				<%
						...
						pst = con.prepareStatement("select * from Per_event where peid= ?");
						pst.setString(1,peid);
			    		rs = pst.executeQuery();
			...
			<div class="input-box">
                ...
                <input type="text"  placeholder="Event Id" value="<%= rs.getString("peid")%>|<%= rs.getString("f_name")%>" name="ceid" id="ceid" readonly required> 
             </div><br><br>
             <div class="input-box">
             ...
             <div class="input-box">
                ...
                <select class="form-select" name="type" id="type">
                      ...
                      <option>Birthdays.
                      </option><option>Wedding Anniversaries.</option>
             		  <option>Weddings.</option>
             		  <option>Themed Parties.</option>
			 ...
			 <div align="center">
				 <a href="PerEventsRead.jsp"><input class="btn view" type="Button" value="View Details"></a>
		     </div>
            </div>
          </form>
       </div>
