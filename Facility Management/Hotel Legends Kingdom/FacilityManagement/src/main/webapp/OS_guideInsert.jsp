   			...
   			<form action ="OSGuidetInsert" method="post">
		   				...
		   				<div class="user-details">
		   					...
		   					<div class ="input-box">
		   						...
		   						<input type="text" name="lan" placeholder="Enter your language" required>
		   					</div>
		   					...
		   					<div class ="input-box">
		   						...
		   						<input type="date" name="datee" placeholder="" required>
		   					</div>
		   					...
		   					<div class ="input-box">
		   						...
		   						<input type="tel" name="cono" placeholder="0XX-XXX-XXXX" pattern="[0-9]{10}" required>
		   					</div>
		   					...
		   					<div class ="input-box">
		   						...
		   						<textarea name="place" rows="4" cols="54" > </textarea>
		   					</div>
