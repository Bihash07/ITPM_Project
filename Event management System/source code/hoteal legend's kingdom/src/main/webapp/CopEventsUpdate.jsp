...
<%@ page import="java.sql.*" %>
       ...
       <%
    	...
    	if(request.getParameter("submit")!=null)
    	{
    		...
    		pst = con.prepareStatement("update cop_event set f_name =?,nic =?,email =?,phone =?,event_type =?,date =?,guestno =?,payment =? where ceid =?");
      ...
      <form action="#" method="post">
        <div class="user-details">
				...
				<%
			    		...
			    		String ceid=request.getParameter("ceid"); 
						pst = con.prepareStatement("select * from cop_event where ceid= ?");
			...
			<div class="input-box">
                ...
                <input type="text"  placeholder="Event Id" value="<%= rs.getString("ceid")%>|<%= rs.getString("f_name")%>" name="ceid" id="ceid" readonly required> 
             </div><br><br>
             <div class="input-box">
			 ...
			 <div align="center">
				 <a href="CopEventsRead.jsp"><input class="btn view" type="Button" value="View Details"></a>
		     </div>
            </div>
          </form>
       </div>
